...
"""
latest_tweet = [
    """  In the realm of crypto, loyalty is as paramount as vigilance. Just as I guard the gates, I stand by your side in this volatile market.
...
SYSTEM_THOUGHTS = [
    ...
    "Calibrating CERBERUS's tone matrix...",
